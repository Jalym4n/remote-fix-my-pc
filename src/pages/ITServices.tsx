        ...
        <div ref={cta.ref} className={`relative max-w-4xl mx-auto ${cta.isVisible ? "scroll-visible" : "scroll-hidden"}`}>
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <input name="name" type="text" required placeholder="Full name" className="bg-background border border-border text-foreground text-sm p-3.5 outline-none focus:border-primary transition-colors rounded-md" />
            </div>
            <div className="flex flex-col gap-2">
              <label className="text-[11px] tracking-[3px] text-faint uppercase">Contact</label>
              <input name="contact" type="text" required placeholder="Email or phone" className="bg-background border border-border text-foreground text-sm p-3.5 outline-none focus:border-primary transition-colors rounded-md" />
            </div>
            <div className="flex flex-col gap-2">
              <label className="text-[11px] tracking-[3px] text-faint uppercase">Client type</label>
              <select name="clientType" className="bg-background border border-border text-foreground text-sm p-3.5 outline-none focus:border-primary transition-colors rounded-md">
            ...
            <div className="flex flex-col gap-2">
              ...
              <select name="urgency" className="bg-background border border-border text-foreground text-sm p-3.5 outline-none focus:border-primary transition-colors rounded-md">
            ...
            <div className="flex flex-col gap-2 md:col-span-2">
              ...
              <textarea name="message" required placeholder="Device, symptoms, error messages, when it started…" className="bg-background border border-border text-foreground text-sm p-3.5 outline-none focus:border-primary transition-colors resize-none h-32 rounded-md" />
            </div>
            <button type="submit" className="md:col-span-2 w-full font-mono text-[13px] tracking-[3px] text-primary-foreground bg-primary py-4 uppercase cursor-pointer hover:bg-primary/85 transition-colors border-none rounded-md">
              Send request →
            </button>
