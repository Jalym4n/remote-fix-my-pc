...
const ITServices = () => {
  ...
  return (
    <div className="bg-background min-h-screen text-foreground">
      ...
      {/* CTA / Contact */}
      <section id="it-contact" className="px-6 md:px-20 py-24 md:py-32 bg-surface bg-noise bg-circuit relative">
        <div className="absolute inset-0 glow-bottom pointer-events-none" />
        <div ref={cta.ref} className={`relative max-w-5xl mx-auto ${cta.isVisible ? "scroll-visible" : "scroll-hidden"}`}>
          <div className="text-[12px] tracking-[4px] text-faint uppercase mb-3 text-center">// contact</div>
          <h2 className="font-display text-[clamp(36px,5.4vw,64px)] tracking-[-0.02em] mb-5 text-center leading-[1.05]">
            Get your device <span className="text-primary">sorted.</span>
          </h2>
          <p className="text-base md:text-lg text-dim leading-relaxed text-center max-w-2xl mx-auto mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-3xl mx-auto mb-10">
            <a
              ...
              className="group flex items-center gap-4 bg-surface2 border border-border hover:border-primary rounded-md p-5 transition-colors"
            >
          ...
          <div className="flex items-center gap-4 max-w-3xl mx-auto mb-6">
            ...
            <span className="text-[11px] tracking-[3px] text-faint uppercase">Or send a request</span>
            <div className="flex-1 h-px bg-border" />
          </div>
