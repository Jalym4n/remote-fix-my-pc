...
const services = [
  ...
  { icon: "🛟", title: "Remote Rescue", desc: "Global remote support for software issues — virus removal, slow PC, setup, configuration. Guided FaceTime / WhatsApp onboarding for non-technical users.", price: "→ From CA$30", flagship: true },
  { icon: "💻", title: "Laptop & Desktop Repair", desc: "Cracked screens, dead batteries, won't boot, overheating, OS reinstalls and component upgrades.", price: "→ From CA$30" },
  ...
  { icon: "🦠", title: "Virus & Malware Removal", desc: "Ransomware, adware, spyware. Full clean-up plus hardening to prevent re-infection.", price: "→ From CA$25" },
  { icon: "⚡", title: "Speed & Tune-Up", desc: "Slow boot, lag, storage pressure. Deep clean, optimisation, bloatware removal.", price: "→ From CA$25" },
  { icon: "🌐", title: "Network & Wi-Fi", desc: "Dead zones, slow speeds, router and printer configuration. Home and small-business networks.", price: "→ From CA$30" },
  { icon: "🛠️", title: "Setup & Onboarding", desc: "New device setup, data migration, account configuration, peripheral installation.", price: "→ From CA$25" },
];
