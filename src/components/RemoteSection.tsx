const RemoteSection = () => {
  return (
    <section id="remote" className="px-6 md:px-20 py-20 md:py-24 bg-background">
      <div className="text-[10px] tracking-[6px] text-faint uppercase mb-3">// remote support</div>
      <div className="font-display text-[clamp(40px,5vw,60px)] text-foreground tracking-[2px] mb-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mt-10">
        ...
        <div className="border border-primary/30 bg-primary/5 p-8 md:p-10 relative overflow-hidden">
          ...
          <h3 className="font-display text-3xl tracking-[2px] text-foreground mb-4">Remote Desktop Repair</h3>
          <p className="text-xs text-dim leading-[2] tracking-[1px] mb-4">
            <strong className="text-foreground font-normal">Too far for a house visit? No problem.</strong> We can fix almost any software issue by remotely connecting to your computer. Screen sharing, remote desktop — we guide you through every step.
          </p>
          <p className="text-xs text-dim leading-[2] tracking-[1px] mb-4">
            Not sure how to set it up? We'll <strong className="text-foreground font-normal">FaceTime or video-call you</strong> and walk you through the initial connection step-by-step. Even if you've never done anything like this before.
          </p>
          <div className="border border-border bg-surface p-4 mt-4">
            <div className="font-display text-lg text-green tracking-[2px] mb-2">PERFECT FOR:</div>
            <ul className="text-[11px] text-dim leading-[2.2] tracking-[1px] space-y-1">
          ...
          <div className="text-[10px] tracking-[3px] text-primary mt-5 uppercase">
        ...
        <div className="border border-border bg-surface p-8 md:p-10 relative overflow-hidden">
          ...
          <h3 className="font-display text-3xl tracking-[2px] text-foreground mb-4">House Visits</h3>
          <p className="text-xs text-dim leading-[2] tracking-[1px] mb-4">
          ...
          <div className="border border-border bg-background p-4 mt-4">
            <div className="font-display text-lg text-primary tracking-[2px] mb-2">HOW IT WORKS:</div>
            <ul className="text-[11px] text-dim leading-[2.2] tracking-[1px] space-y-1">
          ...
          <div className="text-[10px] tracking-[3px] text-green mt-5 uppercase">
