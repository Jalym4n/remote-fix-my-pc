const About = () => {
  return (
    <section id="about" className="px-6 md:px-20 py-20 md:py-24 bg-surface">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div>
          <div className="text-[10px] tracking-[6px] text-faint uppercase mb-3">// about</div>
          ...
          <p className="text-xs text-dim leading-[2.2] tracking-[1px] mb-5">
          ...
          <div className="grid grid-cols-2 gap-px bg-border border border-border mt-10">
            {[
              ...
              <div key={s.label} className="bg-surface-2 p-6">
                ...
                <div className="text-[10px] tracking-[3px] text-dim uppercase mt-1.5">{s.label}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="bg-[#0a0a0a] border border-border-light font-mono">
          <div className="bg-muted border-b border-border px-3.5 py-2 flex items-center gap-2">
            ...
            <span className="text-[11px] text-dim tracking-[2px] ml-2">altctrl — repair/run_</span>
          </div>
          <div className="p-6 text-xs leading-[2]">
            ...
            <div className="text-dim pl-6">Scanning hardware components...</div>
            ...
            <div className="text-primary pl-6">[ Thermal: CPU temp 98°C — WARNING ]</div>
            ...
            <div className="text-dim pl-6">→ Recommend backup before repair.</div>
